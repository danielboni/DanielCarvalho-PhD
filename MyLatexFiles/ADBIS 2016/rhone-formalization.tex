...
% \begin{figure}[h!]
% \center
% \includegraphics[scale=0.85]{concreteservices.pdf}
% \caption{Concrete services available.}\label{fig:scenario}
% \end{figure}
%
%
%\begin{flushleft}
%\small
%$S1(d?; p!) := A1(d?; p!)[availability > 98\%, \ price \ per \ call = 0.2\$]$ \\
%$S2(d?; p!) := A1(d?; p!)[availability > 98\%, \ price \ per \ call = 0.1\$]$ \\
%$S3(p?; dna!) := A2(p?; dna!)[availability > 99\%, \ price \ per \ call = 0.1\$]$ \\
%$S4(d?; dna!) := A1(d?; p!), A2(p?; dna!)[availability > 98\%, \ price \ per \ call = 0.1\$]$ \\
%$S5(p?; info!) := A3(p?; info!)[availability > 98\%, \ price \ per \ call = 0.0\$]$ \\
%$S6(d?; dna!, info!) := A1(d?; p!), A2(p?; dna!), A3(p?; info!)[availability > 99\%, \ price \ per \ call = 0.2\$]$ \\
%$S7(d?; r!) := A4(d?; r!)[availability > 99\%, \ price \ per \ call = 0.2\$]$ \\
%\end{flushleft}
%
