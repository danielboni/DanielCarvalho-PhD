Integrating data across different databases and providing a unique view of it to the user is a well-known problem in the database domain called data integration.
