...
query rewriting for data integration. The originality of  \textit{Rhone} is the rewriting process
...
evaluation; and it shows that quality can be improved on data integration solutions.
