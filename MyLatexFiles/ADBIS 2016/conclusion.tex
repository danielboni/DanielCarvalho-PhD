...
We are currently performing improvements in the implementation and setting up a multi-cloud simulation in in order to evaluate the performance of the \textit{Rhone} in such context.