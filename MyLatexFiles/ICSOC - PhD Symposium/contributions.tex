To address the problem we proposed a metamodel to guide the solution and the specification of our approach. Figure~\ref{fig:scenario} illustrates our data integration metamodel.
