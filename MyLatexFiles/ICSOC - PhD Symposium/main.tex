...
\title{Towards Quality Guided Data Integration on Multi-Cloud Settings}
...
\begin{abstract}
This PhD project addresses data integration considering data quality (freshness, provenance, cost, availability) properties in a multi-cloud context. 
...
\section{An SLA-based Data Integration Approach: a model oriented vision}
\input{contributions}
