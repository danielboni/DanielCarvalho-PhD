...
The project takes a new angle of the problem by considering at real-time the four dimensions (Data providers, data consumer, the infrastructure, and the data itself), their characteristics and constraints including quality, security, privacy traduced in SLAs, and proposing an SLA-based data integration approach in a multi-cloud environment.
The objective is to enhance the quality and performance on data integration
taking into consideration the economic model imposed by the cloud. At this
