...
integration using quality measures. We present a running scenarion to describe
the \textit{Rhone}'s implementation in order to validate the algorithm.
\end{abstract}
...
\section{Conclusions}
The algorithm is implemented in Java. We are currently performing experiments
in order to evaluate the performance of the Rhone.
