...
\additionalauthors{
Pl\'acido A. Souza Neto (Federal Institute of RN, Brazil,\\ \texttt{placido.neto@ifrn.edu.br}),
Nadia Bennani (LIRIS - INSA Lyon, France, \texttt{nadia.bennani@insa-lyon.fr}), and
Genoveva Vargas-Solar (CNRS-LIG, France, \texttt{genoveva.vargas@imag.fr}).
}
\maketitle
