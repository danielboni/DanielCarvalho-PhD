...
The approach begins looking for previous \textit{integrated SLAs} that can be matched with the user query and user' preferences (lines 2 - 6), and adding them to the set $pI$ (line 4). 
%
...
%
Finally, the \textit{integrated SLA} is stored to be used in a next query.   
