...
/**
 * This is the item provider adapter for a {@link SLAModel.Query} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SLAModelPackage.Literals.QUERY__SERVICECOMPOSITION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIntegrationslaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Query_integrationsla_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Query_integrationsla_feature", "_UI_Query_type"),
				 SLAModelPackage.Literals.QUERY__INTEGRATIONSLA,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SLAModelPackage.Literals.QUERY__SERVICECOMPOSITION);
		}
