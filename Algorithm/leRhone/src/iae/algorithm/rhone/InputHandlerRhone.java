 ...
 */
public class InputHandlerRhone {
	 ...
	 */
	public static Rhone handleArguments(String[] args) {
	 ...
	 *         and the views.
	 */
	public static Rhone parseInput(String queryStr, List<String> viewsStr) {
	...
	private static Rhone sqlInput() {
		...
		return new Rhone (datalogQuery, views);
	}
	 ...
	 * @return MiniCon object
	 */
	private static Rhone readInput() {
	 ...
	 * @return MiniCon object
	 */
	public static Rhone readFile(String testcaseFile, String testID) {
	 ...
	 * @return MiniCon object
	 */
	public static Rhone readSQLFile(String testcaseFile, String testID) {
	 ...
	 * @return MiniCon object
	 */
	public static Rhone handleSQLFileInput(List<String> schema,
