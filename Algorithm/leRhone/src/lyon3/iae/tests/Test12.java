...
public class Test12 {
	...
	public static void main(String[] args) throws DocumentException, SQLException, IOException {
		...
		String resultFileName = "result_test_12.txt";
		File file = new File(resultFileName);
		FileWriter writer = new FileWriter(file, true);
		
		writer.write("Database with 10000 queries.\n");
...
//				long start = ManagementFactory.getThreadMXBean().getCurrentThreadUserTime();
				...
				String r = queryManager.findSimilarityType(rhone.getQuery(), "query_history_10");
