package lyon3.iae.datamodel.populate.experiment7;
...
public class TestExperiment2 {
	...
	public static void main(String[] args) throws DocumentException, SQLException, IOException {
		...
		String resultFileName = "rewriting_5_300.txt";
		File file = new File(resultFileName);
		FileWriter writer = new FileWriter(file, true);
		
		writer.write("Results from rewriting queries with 5 abstract services and 500 matches.\n");

		Rhone rhone = InputHandler.handleArguments("R-T9.xml", "3");

		long tempInicial = System.currentTimeMillis();

		rhone.selectCandidateServicesFromDB("query_history_19");
