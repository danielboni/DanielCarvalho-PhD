package lyon3.iae.datamodel.populate.experiment4;
...
public class TestExperiment3 {
	...
	public static void main(String[] args) throws DocumentException, SQLException, IOException {
		...
		String resultFileName = "rewriting_2_200.txt";
		File file = new File(resultFileName);
		FileWriter writer = new FileWriter(file, true);
		
		writer.write("Results from rewriting queries with 2 abstract services and 200 matches.\n");

		Rhone rhone = InputHandler.handleArguments("R-T9.xml", "0");

		long tempInicial = System.currentTimeMillis();

		rhone.selectCandidateServicesFromDB("query_history_23");
