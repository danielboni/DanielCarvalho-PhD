...
public class TestExperiment3 {
	...
	public static void main(String[] args) throws DocumentException, SQLException, IOException {
		...
		String resultFileName = "rewriting_4_200.txt";
		File file = new File(resultFileName);
		FileWriter writer = new FileWriter(file, true);
		
		writer.write("Results from rewriting queries with 4 abstract services and 200 matches.\n");

		Rhone rhone = InputHandler.handleArguments("R-T9.xml", "2");

		long tempInicial = System.currentTimeMillis();

		rhone.selectCandidateServicesFromDB("query_history_21");
