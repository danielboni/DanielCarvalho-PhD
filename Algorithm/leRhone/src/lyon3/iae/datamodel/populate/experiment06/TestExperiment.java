package lyon3.iae.datamodel.populate.experiment06;
...
public class TestExperiment {
	...
	public static void main(String[] args) throws DocumentException, SQLException, IOException {
		...
		String resultFileName = "rewriting_4_500.txt";
		File file = new File(resultFileName);
		FileWriter writer = new FileWriter(file, true);
		
		writer.write("Results from rewriting queries with 4 abstract services and 500 matches.\n");

		Rhone rhone = InputHandler.handleArguments("R-T9.xml", "2");

		long tempInicial = System.currentTimeMillis();

		rhone.selectCandidateServicesFromDB("query_history_14");
