create database if not exists query_history_9;
use query_history_10;
...
insert into tb_abstract_service values
(7, 'A7', 'given disease x, returns infected patients y'),
(8, 'A8', 'given patient x, returns his pernonal information y'),
(9, 'A9', 'given doctor x, returns threated patients y'),
(10, 'A10', 'given patient x, returns dna information y');
...
alter table tb_query_history modify column definition varchar(200);
