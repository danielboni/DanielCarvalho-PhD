...
public class PCD {
	...
	/** list of mappings between abstract services in the definition of the query and abstract services in the concrete service definition */
	private List<MCDMappings> phi;
	
	/** variable, constant and rewriting mapping */
	public MCDMappings mappings;
	//protected MCDMappings mappings; /* C.BA */
	/** query object */
	...
	public PCD(Predicate subgoal, DatalogQuery query, DatalogQuery view,
			List<MCDMappings> mappings) {
		this.setPhi(mappings);
		this.query = query;
		this.view = view;
	...
	public PCD(List<Predicate> coveredAbstractServices,
			List<MCDMappings> mappings2, DatalogQuery concreteService) {
		this.setPhi(mappings2);
		this.coveredSubgoals = new ArrayList<Predicate>();
		this.coveredSubgoals.addAll(coveredAbstractServices);
		this.view = concreteService;
	}
...
//		}
	 ...
	 */
	public boolean isDisjoint(PCD mcd) {
	...
	public List<MCDMappings> getPhi() {
		return phi;
	}

	public void setPhi(List<MCDMappings> phi) {
		this.phi = phi;
	}
