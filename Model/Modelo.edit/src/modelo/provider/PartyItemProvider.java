...
/**
 * This is the item provider adapter for a {@link modelo.Party} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Party_sla_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Party_sla_feature", "_UI_Party_type"),
				 ModeloPackage.Literals.PARTY__SLA,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModeloPackage.Literals.PARTY__NAME,
				 true,
				 false,
				 false,
