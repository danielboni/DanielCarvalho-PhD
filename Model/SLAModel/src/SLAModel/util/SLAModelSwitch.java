 ...
 * @generated
 */
public class SLAModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SLAModelPackage.SLA: {
				SLA sla = (SLA)theEObject;
				T result = caseSLA(sla);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SLAModelPackage.OBLIGATIONS: {
				Obligations obligations = (Obligations)theEObject;
				T result = caseObligations(obligations);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SLAModelPackage.PARTIES: {
				Parties parties = (Parties)theEObject;
				T result = caseParties(parties);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SLAModelPackage.SERVICE_CONSUMER: {
				ServiceConsumer serviceConsumer = (ServiceConsumer)theEObject;
				T result = caseServiceConsumer(serviceConsumer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SLAModelPackage.SERVICE_PROVIDER: {
				ServiceProvider serviceProvider = (ServiceProvider)theEObject;
				T result = caseServiceProvider(serviceProvider);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SLAModelPackage.GARANTEE: {
				Garantee garantee = (Garantee)theEObject;
				T result = caseGarantee(garantee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SLAModelPackage.METRIC: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Obligations</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Obligations</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseObligations(Obligations object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parties</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parties</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParties(Parties object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Garantee</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Garantee</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGarantee(Garantee object) {
		return null;
	}
