...
/**
 * This is the item provider adapter for a {@link modelo.ServiceComposition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceComposition_service_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceComposition_service_feature", "_UI_ServiceComposition_type"),
				 ModeloPackage.Literals.SERVICE_COMPOSITION__SERVICE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addQueryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceComposition_query_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceComposition_query_feature", "_UI_ServiceComposition_type"),
				 ModeloPackage.Literals.SERVICE_COMPOSITION__QUERY,
				 true,
				 false,
				 true,
				 null,
